...
hs.DisplayName = 'Individual data points';
hr = yline(ax,...
    40,...
    '--',...
    '40 dots',...
...
hr.DisplayName = 'Physical numerosity';
...
lgd = legend(ax,...
    [hb he hs],...
    {'Mean','Standard deviation','Individual data points'},...
